...
namespace LittleBlocks.Notifications.UnitTests;
...
public class NotificationServiceFixture
{
    ...
    {
        Sender = "sender@LittleBlocks.com",
        Profiles = new[]
        {
            new NotificationProfile
            {
                ProfileName = "DefaultProfile",
                Audiences = new[]{ new NotificationAudience {Email = "mohammad.moattar@LittleBlocks.com" } }
            },
        },
        Templates = new[]
        {
